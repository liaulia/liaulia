              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <div class="form-group">
                    <input type="text" name="nik" class="form-control form-control-user" placeholder="Masukkan NIK" maxlength="16">
                  </div>
                  ...
                  <div class="form-group">
                    <input type="tel" name="telp" class="form-control form-control-user" placeholder="Masukkan nomor telepon" maxlength="14">
                  </div>
